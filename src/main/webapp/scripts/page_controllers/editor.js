...
/**
 * Initialisation of the drawable grid in order to edit a custom level
 */
...
/**
 * Draw a custom grid based on the user custom height and width
 */
function drawGrid() {
...
/**
 * Redraw the custom user level grid based on a size change
 */
...
/**
 * Generate errors based on rules of a custom level
 */
...
/**
 * Stock the actual grid into a 2 dimension array and redifine the untouchs
 *  / undefined cases by an empty case
 */
