/**
 * Handle the verification and the css style of the instructions of a Level
 *  Redundancy in the initialisation and some other method about the game and grid
 */
